...
function prepareSavedEntryAttempt({
	latestEntry,
	traceEvent,
}: {
...
async function resolvePreparedSavedEntrySecurity({
	runContext,
	prepared,
	resolveKeySecurity,
	traceEvent,
...
async function runPreparedSavedEntryAttempt({
	platformOS,
	runContext,
	recovery,
	traceEvent,
	...
	return await runSavedEntryConnectionAttempt({
		platformOS,
		runContext,
