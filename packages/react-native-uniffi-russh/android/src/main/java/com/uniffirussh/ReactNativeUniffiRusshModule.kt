...
@ReactModule(name = ReactNativeUniffiRusshModule.NAME)
class ReactNativeUniffiRusshModule(reactContext: ReactApplicationContext) :
  NativeReactNativeUniffiRusshSpec(reactContext) {
  ...
  // fressh-react-native-uniffi-russh.cpp
  ...
  companion object {
    const val NAME = "ReactNativeUniffiRussh"

    init {
      System.loadLibrary("fressh-react-native-uniffi-russh")
    }
  }
}