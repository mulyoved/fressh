...
| Task 2 | Session Node: exit 1, missing `session-core` and `session-diagnostics`; session Jest: exit 1, missing `session`; typed controller group: 87 passed, 63 failed; Worktree typed adapter: 13 passed, 2 failed because it still read the raw channel; stable review successor exposure: 0 passed, 1 failed; stable review generation-bound diagnostics: 0 passed, 1 failed; stale architecture suites: 8 passed, 13 failed | Session Node: 33 passed; session/activity Jest: 10 passed; typed controllers: 174 passed; Worktree/keyboard: 28 passed; session/typed-terminal architecture: 8 passed; Worktree modal: 2 passed; formatting, typecheck, scoped ESLint, and diff check: exit 0 | `68e60f0f..52347f98`, `a7a291b7..a7da6ebc`, selective `8c8e2b13` contract | `4faea527`, stable-review fix `4ba4bde3`   |
